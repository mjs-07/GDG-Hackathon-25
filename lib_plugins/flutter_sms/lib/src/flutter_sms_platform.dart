...
class FlutterSmsPlatform extends PlatformInterface {
  ...
  Future<String> sendSMS({
    ...
    if (!kIsWeb && Platform.isIOS) {
      ...
      String phones = recipients.join(';');
      mapData['recipients'] = phones;
  ...
  Future<bool> launchSmsMulti(List<String> numbers, [String? body]) {
    ...
    if (body != null) {
      final body0 = Uri.encodeComponent(body);
      return launch('sms:/open?addresses=$phones${separator}body=$body0');
    }
    return launch('sms:/open?addresses=$phones');
  }
  ...
  Future<bool> launchSms(String? number, [String? body]) {
    ...
    if (body != null) {
      final body0 = Uri.encodeComponent(body);
      return launch('sms:/$number${separator}body=$body0');
    }
